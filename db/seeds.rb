...
@whopper = Food.create(name: 'Whopper', review: 'Its what Kings eat.', image: 'https://bk-latam-prod.s3.amazonaws.com/sites/burgerking.com.mx/files/WHOPPER-500X540-GRILLED.png', user: @admin)
puts "#{Food.count} foods created"
@chcickensand = Food.create(name: 'Chicken Sandwich', review: 'eat more chickn', image: 'https://www.cfacdn.com/img/order/COM/Menu_Refresh/Sides/Sides%20PDP/_0000s_0013_Final__0052_CFA_PDP_Spicy-Chick-Fil-A-Sandwich_1085.png', user: @admin)
puts "#{Food.count} foods created"
@bigmac = Food.create(name: 'Big Mac', review: `I'm not loving this`,  image: 'https://upload.wikimedia.org/wikipedia/commons/9/9a/Big_Mac_hamburger.jpg', user: @admin)
puts "#{Food.count} foods created"
@dbldbl = Food.create(name: 'Double Double', review: 'Get that animal style', image: 'https://www.in-n-out.com/Frontend-Assembly/Telerik.Sitefinity.Frontend/content/images/menu/foodquality/double-double.png?package=INNOUT', user: @admin)
puts "#{Food.count} foods created"
@shamrock = Food.create(name: 'Shamrock Shake', review: 'This is what 3 leprechauns in a blender taste like', image: 'https://cdn.cnn.com/cnnnext/dam/assets/200218142054-20200218-mcdonalds-shamrock-shake-super-tease.jpg', user: @admin)
puts "#{Food.count} foods created"
@cheesypot = Food.create(name: 'Cheesy Fiesta Potatoes', review: 'Taken from us way too soon', image: 'https://www.tacobell.com/images/22530_cheesy_fiesta_potatoes_269x269.jpg', user: @admin)
puts "#{Food.count} foods created"
@fivelayer = Food.create(name: '5 Layer Burrito', review: 'Because 4 layers just isnt enough', image: 'https://www.tacobell.com/images/22167_beefy_5_layer_burrito_269x269.jpg', user: @admin)
puts "#{Food.count} foods created"
@famousbowl = Food.create(name: 'Famous Bowl', review: 'Although it is my favorite thing at KFC Ive never had one that even looks remotely like the one in this picture', image: 'https://www.kfc.com/assets/products/G15022_KFC_41-famous-bowl-Enviro_0571_RGB-copy.jpg', user: @admin)
puts "#{Food.count} foods created"
@chickenFries = Food.create(name: 'Chicken Fries', review: 'Chickens dont have fries...', image: 'https://www.chewboom.com/wp-content/uploads/2018/07/1.69-Original-Chicken-Fries-At-Burger-King-For-A-Limited-Time-678x381.jpg', user: @admin)
puts "#{Food.count} foods created"
